...
## [pass] UC-001: Авторизация через Email+OTP
...
3. Генерация 6-значного кода (dev: всегда 000000), сохранение с TTL 15 минут
...
**Уведомления:**
- OTP email: "Ваш код для входа — Налоговик" / "Ваш код: {code}, действителен 15 минут"
...
## [pass] UC-002: Выбор роли при первом входе
...
## [pass] UC-003: Онбординг SPECIALIST
...
- OTP TTL для change-email: 15 мин (отличается от auth: 15 мин в коде)
...
## [pass] UC-010: Создание налогового запроса
...
## [pass] UC-011: Просмотр своих запросов
...
## [pass] UC-013: Редактирование/закрытие/отмена запроса
...
## [pass] UC-014: Оставить отзыв специалисту
...
## [pass] UC-015: Просмотр своих отзывов
...
## [pass] UC-020: Редактирование профиля специалиста
...
## [pass] UC-021: Просмотр ленты запросов в своих городах
...
## [pass] UC-023: Просмотр своих откликов
...
## [pass] UC-032: REST fallback для сообщений
...
## [pass] UC-040: Каталог специалистов
...
## [pass] UC-041: Публичный профиль специалиста
...
## [pass] UC-050: Статистика платформы
...
## [pass] UC-051: Управление пользователями и специалистами
...
## [pass] UC-071: Admin — просмотр и удаление отзывов
...
## [pass] UC-077: Admin — блокировка пользователя
...
## [pass] UC-078: CTA "Разместить запрос" на лэндинге
...
## [pass] UC-062: Настройки аккаунта
...
## [pass] UC-073: Публичный endpoint ленты запросов
...
## [pass] UC-074: Публичный endpoint деталей запроса
