...
export interface PageEntry {
  ...
  navFrom?: string[];
  /** Last QC score (0–10), updated after each proto-check pass */
  qaScore?: number;
...
export const pageRegistry: PageEntry[] = [
  ...
  // Specialist
  { id: 'specialist-dashboard', title: 'Кабинет специалиста', group: 'Specialist', route: '/specialist', stateCount: 2, nav: 'specialist', activeTab: 'dashboard', api: [
    'GET /api/specialist/stats',
    'GET /api/specialist/requests?status=new&limit=5',
  ] },
  { id: 'specialist-respond', title: 'Отклик специалиста', group: 'Specialist', route: '/specialist/respond', stateCount: 3, nav: 'specialist', activeTab: 'dashboard', api: [
    'GET /api/requests/:id',
    'POST /api/responses',
  ] },
