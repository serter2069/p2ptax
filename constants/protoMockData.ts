...
export const MOCK_SERVICES = ['3-НДФЛ', 'Регистрация ИП', 'Налоговый вычет', 'Налоговая проверка', 'Ликвидация ИП', 'Не знаю'];
...
export const MOCK_REQUESTS: MockRequest[] = [
  ...
  },
  {
    ...
    description: 'Купил квартиру в 2025 году, хочу получить имущественный налоговый вычет. Нужна помощь с документами.',
    city: 'Казань',
  ...
  {
    id: '4',
    title: 'Камеральная проверка — нужна помощь',
    description: 'Получил требование о предоставлении документов при камеральной проверке. Нужен специалист.',
    city: 'Екатеринбург',
    fns: 'ФНС №8 по г. Екатеринбургу',
    service: 'Налоговая проверка',
    status: 'COMPLETED',
