...
function LoadingState() {
  return (
    <View style={s.container}>
      <View style={s.header}>
        <View style={[s.skelLine, { width: 80, alignSelf: 'center' }]} />
        <View style={[s.skelLine, { width: 200, height: 20, alignSelf: 'center' }]} />
      </View>
      <View style={s.plans}>
        {[1, 2, 3].map((i) => (
          <View key={i} style={[s.planCard, { opacity: 0.5 }]}>
            <View style={[s.skelLine, { width: '50%', height: 16 }]} />
            <View style={[s.skelLine, { width: '40%', height: 24 }]} />
            <View style={s.divider} />
            <View style={[s.skelLine, { width: '80%' }]} />
            <View style={[s.skelLine, { width: '70%' }]} />
            <View style={[s.skelLine, { width: '60%' }]} />
            <View style={[s.skelLine, { width: '100%', height: 40, borderRadius: BorderRadius.btn }]} />
          </View>
        ))}
      </View>
    </View>
...
export function PricingStates() {
  return (
    <View style={{ gap: Spacing['4xl'] }}>
      <StateSection title="DEFAULT" pageId="pricing">
        <DefaultState />
      </StateSection>

      <StateSection title="LOADING" pageId="pricing">
        <LoadingState />
      </StateSection>
    </View>
  );
