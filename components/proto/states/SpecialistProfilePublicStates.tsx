...
const MOCK_SPECIALIST = {
  ...
  fnsServices: [
    { fns: 'ФНС №15 по г. Москве', services: ['3-НДФЛ', 'Регистрация ИП', 'Налоговый вычет'] },
    { fns: 'ФНС №46 по г. Москве', services: ['Регистрация ИП', 'Ликвидация ИП'] },
  ],
  reviews: [
    { author: 'Мария К.', date: '2024-03-15', rating: 5, text: 'Отличный специалист, помог с декларацией' },
  ...
  return (
    <>
      ...
      <StateSection title="TYPING_MESSAGE">
        <ProfileScreen initialMessage="Здравствуйте! Мне нужна помощь с подачей декларации 3-НДФЛ за 2024 год. Подскажите, какие документы потребуются?" />
      </StateSection>
    </>
  );
}
