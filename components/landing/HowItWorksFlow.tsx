...
const STEPS = [
  {
    ...
    body: "Тип проверки, город, ФНС, суть — 2–3 минуты",
  },
  {
    num: "2",
    title: "Получите ответы",
    body: "Специалисты по вашей ФНС напишут в течение дня. Выберите того, кому доверяете",
  },
  {
    num: "3",
    title: "Работайте напрямую",
    body: "Без комиссий. Связь через чат. Контакты видны сразу после выбора",
  },
];
    ...
    >
      ...
      >
        <View style={{ marginBottom: isDesktop ? 56 : 40, alignItems: "center" }}>
          ...
          >
            Три шага от паники к специалисту
          </Text>
        </View>
        ...
        >
          ...
          >
            <Text style={{ color: colors.text, fontWeight: "600" }}>
              Без подписок и комиссий.
            </Text>{" "}
            Клиент и специалист общаются напрямую, платформа не
            вмешивается в цену и условия.
          </Text>
        </View>
